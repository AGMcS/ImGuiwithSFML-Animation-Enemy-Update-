...
int main() {
    ...
    //enemy class
    Enemy minatour(250, 350, 48, 64, "preview-red(1).png", 48, 92);
    ...
    while (window.isOpen()) {
        ...
        if (!pause) {
            ...
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::C) && !dwarf.cangrapple) {
                dwarf.animation.attack = true;
            }
            ...
            minatour.animation.Animate(minatour.enemyRect, minatour.animation.switchTime);
            minatour.draw(window);
